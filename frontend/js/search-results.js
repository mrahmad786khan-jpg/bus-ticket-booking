document.addEventListener('DOMContentLoaded', async () => {
  ...
  // 2. Fetch Data Directly From Backend Database API with Route Parameters (Updated to relative path)
  try {
    const apiUrl = `/api/buses?from=${encodeURIComponent(fromLocation)}&to=${encodeURIComponent(toLocation)}`;
